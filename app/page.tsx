  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-4 sm:p-6">
      <div className="flex flex-col items-center justify-center gap-4 sm:gap-6 max-w-3xl w-full text-center">
        ...
        <p className="text-lg sm:text-xl text-gray-400">Find your perfect eyewear match</p>
        ...
        <div className="grid grid-cols-1 gap-6 w-full max-w-md mt-4 sm:mt-8">
          <div className="bg-[#0f1117] p-4 sm:p-6 rounded-xl border border-[#1a1c25]">
            ...
            <div className="bg-[#0a0c14] p-3 sm:p-4 rounded-lg mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3">
              <svg
                width="20"
                height="20"
                viewBox="0 0 24 24"
