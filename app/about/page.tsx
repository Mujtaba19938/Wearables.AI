export default function AboutPage() {
  return (
    <main className="flex min-h-screen flex-col items-start p-6 max-w-4xl mx-auto">
      <h1 className="text-4xl font-bold mb-10">About wearables.ai</h1>

      <div className="bg-[#0f1117] p-6 rounded-xl border border-[#1a1c25] w-full mb-8">
        ...
        <p className="text-gray-300">
          ...
          styling principles that have been refined over decades in the eyewear industry.
        </p>
      </div>
