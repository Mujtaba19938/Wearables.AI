    ...
    >
      <div className="container mx-auto px-4 py-6 sm:py-8 max-w-4xl">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-center flex-grow">Guide to Perfect Eyewear</h1>
        </div>
        ...
        {/* Step content */}
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 sm:p-6 mb-6 card-gradient">
              ...
              {currentStep === 1 && (
                <div className="space-y-4">
                  ...
                  <div className="flex justify-center my-6">
                    <div className="relative w-full max-w-md h-48 sm:h-64 rounded-lg overflow-hidden">
                      <Image
